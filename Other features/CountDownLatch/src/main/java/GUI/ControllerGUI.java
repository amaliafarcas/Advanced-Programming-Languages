...
public class ControllerGUI implements Initializable {
    ...
    @FXML
    TableColumn<HashMap.Entry<Integer,Integer>, String> latchTableLocation;
...
//            System.out.println(program.getSymbolsTable().getContent().entrySet());
    ...
    public void setLatchTable() {
        ...
        latchTableLocation.setCellValueFactory(cellData -> new ReadOnlyStringWrapper(Integer.toString(cellData.getValue().getKey())));
        latchTableValue.setCellValueFactory(cellData -> new ReadOnlyStringWrapper(cellData.getValue().getValue().toString()));
        latchTableList.addAll(repository.getProgramStates().get(0).getLatchTable().getLatchTable().entrySet());
