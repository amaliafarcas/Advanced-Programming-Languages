...
public class ControllerGUI implements Initializable {
    ...
    @FXML
    TableColumn<HashMap.Entry<Integer,Integer>, String> lockTableIndex;
...
//            System.out.println(program.getSymbolsTable().getContent().entrySet());
    ...
    public void setLockTable() {
        ...
        lockTableIndex.setCellValueFactory(cellData -> new ReadOnlyStringWrapper(cellData.getValue().getValue().toString()));
        lockTableList.addAll(repository.getProgramStates().get(0).getLockTable().getLockTable().entrySet());
