...
public class ControllerGUI implements Initializable {
    ...
    @FXML
    TableColumn<HashMap.Entry<Integer, Pair<Integer, ArrayList<Integer>>>, String> semaphoreTableIndex;

    @FXML
    TableColumn<HashMap.Entry<Integer, Pair<Integer, ArrayList<Integer>>>, String> semaphoreTableValue;

    @FXML
    TableColumn<HashMap.Entry<Integer, Pair<Integer, ArrayList<Integer>>>, String> semaphoreTableListOfValues;
...
//            System.out.println(program.getSymbolsTable().getContent().entrySet());
    ...
    public void setSemaphoreTable() {
        ...
        semaphoreTableValue.setCellValueFactory(cellData -> new ReadOnlyStringWrapper(cellData.getValue().getValue().getKey().toString()));
